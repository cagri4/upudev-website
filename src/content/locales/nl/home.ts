...
export const homeNl: HomeDictionary = {
  ...homeTr,
  meta: {
    title: "UpuDev | Digitale Producten & Softwareoplossingen",
    description:
      "Softwarebureau gevestigd in Nederland: web, e-commerce, automatisering en AI-gedreven digitale oplossingen. Ondersteuning in het Turks, Nederlands en Engels.",
  },
  partners: {
    ...homeTr.partners,
    ...
    items: [
      {
        ...
        summary:
          "AI-gedreven sales, social media, website en content — één team in één pakket. Beheer van Google-, Facebook- en Instagram-advertenties inbegrepen. Voor uw Turkse onderneming in Nederland: B2B dealerportaal, e-commerce setup en sector-SaaS bij één partner.",
        image:
