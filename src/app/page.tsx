    ...
    <div className="io-page">
      <header className="io-header">
        ...
        <div className="io-wrap io-nav">
          <a href="#ana-sayfa" className="io-logo">
            upu<span>dev</span>
          </a>
          <nav>
            {dict.nav.map((item) => (
      ...
      <main>
        ...
        <SaasProjectsGrid ongoing={dict.ongoing} id="projeler" />

        <section className="io-wrap io-section" id="hizmetler">
          <div className="io-section-head">
            <p className="io-eyebrow">Capabilities</p>
        ...
        <section className="io-wrap io-section" id="hakkimizda">
          <div className="io-two-col">
            <article>
              <p className="io-eyebrow">About</p>
        ...
        <section className="io-wrap io-section" id="surec">
          <p className="io-eyebrow">Process</p>
